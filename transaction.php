 ...
 <!--  <div class="container-fluid">
    ...
    <table class="table table-striped table-md">
      ...
      <tr>
                  ...
                  <?php
                    $bil = 0;
                    $calltbl = "SELECT * FROM trans_history INNER JOIN pelajar ON pelajar.nokp = trans_history.nokp ORDER BY tarikh_transaksi DESC";
                    $toquery = mysqli_query($connect, $calltbl);
                    while ($row=mysqli_fetch_array($toquery)) {
                      $bil += 1;
                        echo "
                            <tr>
                               <td>".$row['nama']."</td>
