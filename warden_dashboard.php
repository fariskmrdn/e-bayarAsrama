...
<html>
<head>
  <title>WARDEN <?=$display['nama']?></title>
...
<body>
  <!-- NAVIGATION BAR USING BOOTSTRAP FRAMEWORK -->
    ...
    <div class="row mx-auto">
      ...
      <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 padding">
        <br>
        <p class="lead padding">WARDEN DASHBOARD</p><p class="lead padding"><?=$display['nama']?></p>
 ...
 <!--  <div class="container-fluid">
    ...
    <table class="table table-striped table-md">
      ...
      <tr>
        <td colspan="6" scope="col" style="background-color: #FFD700;"><h5 style="text-align: center;">SENARAI PELAJAR YANG TELAH HABIS BAYAR</h3></td>
      </tr>
      </thead>
      <tr>
        <th>Bil</th>
      ...
      $cmd1 = "SELECT * FROM pelajar WHERE bayaran = 0";
      $Query1 = mysqli_query($connect,$cmd1);
      $bil = 1;
